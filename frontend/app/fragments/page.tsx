  ...
  useEffect(() => {
    const fetchGifs = async () => {
      try {
        ...
        const gifUrls: string[] = (data.gifs || []).map(
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-gray-800">
        <nav className="flex gap-8">
          <button className="text-sm font-medium text-white border-b-2 border-white pb-2 bg-transparent">
            [FRAGMENTS]
          </button>
          <button className="text-sm font-medium text-gray-400 hover:text-white pb-2 bg-transparent">
            COLLECTIONS
          </button>
          <button className="text-sm font-medium text-gray-400 hover:text-white pb-2 bg-transparent">
            FOLLOWING
